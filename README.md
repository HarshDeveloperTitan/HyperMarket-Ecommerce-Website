...
## Features (Frontend Completed)
 ...
 Dynamic components powered by Redux state management  
 Navbar, Footer, Product Listing, and Product Details pages  
 Add to Cart functionality (UI-only for now)  
 Clean component structure and reusable code design  
